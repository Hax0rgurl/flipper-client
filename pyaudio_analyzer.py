...
FREQS = [FQ_0,FQ_1,FQ_2,FQ_3,FQ_4,FQ_5,FQ_6,FQ_7,FQ_8,FQ_9,FQ_A,FQ_B,FQ_C,FQ_D,FQ_E,FQ_F]
...
def findFreq(pData):
	...
	# for x,y in zip(xf[int(len(xf)/16)*9 - OFFSET:int(len(xf)/16)*9 + OFFSET], pData[int(len(xf)/16)*9 - OFFSET:int(len(xf)/16)*9 + OFFSET]):
	# 	if y >= THRESHOLD:
